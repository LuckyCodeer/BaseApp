package com.yhw.pgyer.http.parser;


import com.yhw.pgyer.bean.BaseResponse;
 ...
 * date 2022/11/8
 */
@Parser(name = "ResponsePgyer")
public class ResponsePgyerParser<T> extends TypeParser<T> {
     ...
     */
    public ResponsePgyerParser(Type type) {
        super(type);
    }
