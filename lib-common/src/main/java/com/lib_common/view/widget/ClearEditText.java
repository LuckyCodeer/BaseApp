 ...
 * 带清除按钮的 EditText
 */
public class ClearEditText extends RegexEditText
    ...
    public ClearEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mClearDrawable = DrawableCompat.wrap(Objects.requireNonNull(ContextCompat.getDrawable(context, R.drawable.ic_del)));
    ...
    private void setDrawableVisible(final boolean visible) {
        ...
        setCompoundDrawables(
                ...
                drawables[3]);
        setCompoundDrawablePadding(DisplayUtil.dip2px(getContext(), 5));
    }
