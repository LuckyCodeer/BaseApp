    ...
    private void initTab() {
        ...
        for (CharSequence item : mItems) {
            ...
            if (i == mSelectedPosition) {
                textView.setTextColor(getResources().getColor(com.huodada.lib_src.R.color.white));
                post(() -> {
                ...
                textView.setTextColor(getResources().getColor(com.huodada.lib_src.R.color.black_666666));
            }
            ...
            mObjectAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    for (int i = 0; i < mItems.length; i++) {
                        ...
                        textView.setTextColor(position == i ? getResources().getColor(com.huodada.lib_src.R.color.white) : getResources().getColor(com.huodada.lib_src.R.color.black_666666));
                    }
